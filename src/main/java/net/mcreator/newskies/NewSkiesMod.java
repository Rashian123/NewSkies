...
@Mod("new_skies")
public class NewSkiesMod {
	public static final Logger LOGGER = LogManager.getLogger(NewSkiesMod.class);
	public static final String MODID = "new_skies";

	public NewSkiesMod(IEventBus modEventBus) {
