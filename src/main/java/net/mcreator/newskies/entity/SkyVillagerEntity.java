...
package net.mcreator.newskies.entity;
...
public class SkyVillagerEntity extends Villager {
	public SkyVillagerEntity(EntityType<SkyVillagerEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
